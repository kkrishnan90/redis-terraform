...
output "vnic_ids" {
  value =  "${lookup(zipmap(data.oci_core_vnic_attachments.instance_vnics[*].vnic_attachments[0].vnic_id,data.oci_core_vnic_attachments.instance_vnics[*].vnic_attachments[0]), "vnic_id")}"
}
