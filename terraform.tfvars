# -- Tenant Information
user_ocid        = "" // user ocid from oci console
tenancy_ocid     = "" // tenancy ocid from oci console
fingerprint      = "" // fingerprint after adding public key to API Keys in users console oci
compartment_ocid = "" // compartment ocid from oci console
...
tenancy_name     = "" // cloud account name ex: rcitpl123
...
hap_instance_image_ocid = "" // Image ocid to use : This image ocid is blank Ubuntu 18.04 - Oracle provided image
hap_subnet_ocid    = "" // Subnet ocid to which the HAProxy machines should be provisioned - should be private subnet
...
app_instance_image_ocid = "" // Image ocid to use: you can use your app image ocid which you have already as custom image
app_subnet_ocid         = "" // Subnet ocid to which App server to be provisioned - should be private subnet
...
load_balancer_subnet_ocid = "" // Subnet ocid to which load balancer to be provisioned - should be public subnet
