# -- Tenant Information
user_ocid        = "ocid1.user.oc1..aaaaaaaaz3thofmupuvnikhptrt5chscgmzlgztxcnir7nwcqw2xzal7w7qq"        // user ocid from oci console
tenancy_ocid     = "ocid1.tenancy.oc1..aaaaaaaaf3gw6vt7iaa5id53irgqdwmozrehsyv65smpk45tgvfizct34yzq"     // tenancy ocid from oci console
fingerprint      = "1f:99:92:d2:a9:df:35:d2:fd:d1:e7:47:83:8b:d7:fe"                                     // fingerprint after adding public key to API Keys in users console oci
compartment_ocid = "ocid1.compartment.oc1..aaaaaaaaz36z2rrvdpohsaw5lvfx2fggonsfczadga3lgf5yvqglft5zp3pq" // compartment ocid from oci console
...
tenancy_name     = "rcitpl123"                                                                           // cloud account name ex: rcitpl123
...
hap_instance_image_ocid = "ocid1.image.oc1.ap-mumbai-1.aaaaaaaaqxnqfn3szq3s6jwlfgmrj7bjdrafsyiynqureu4pdiulq43ovjkq"  // Image ocid to use : This image ocid is blank Ubuntu 18.04 - Oracle provided image
